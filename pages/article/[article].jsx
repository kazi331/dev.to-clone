            ...
            <div className="content">
                ...
                <div className="content-body">
                    <div className="author">
                        <Link href={`/author/2`} ><Image src="https://api.lorem.space/image/face?w=150&h=150" alt="" width="40" height="40" /></Link>
                        <div>
                            <h4><Link href={`/author/2`} ><span>John doe</span></Link></h4>
                            <small>Posted 2 days ago</small>
                        </div>
                        <div className="action">
                            <button className='edit'><Link href={`/write/?id=2`}  type="submit">{EditIcon}</Link></button>
